...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-$lm2)sx5a92#98jnx#4&u0=2#z5=5w3%i0cc!2be_-i1j9$i#o')
...
if not DEBUG:
    # Use more relaxed security settings for PythonAnywhere
